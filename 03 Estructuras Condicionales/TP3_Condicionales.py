...
numeros = int(input("Ingrese un numero para determinar si es par o impar: "))
...
if edad < 13:
    print(f"Usted es Niño/a, tiene {edad} años")
elif edad >= 12 and edad <= 18:
    print(f"Usted es Adolescente, tiene {edad} años")
elif edad >= 18 and edad < 30:
    print(f"Usted es Adulto/a joven, tiene {edad} años")
elif edad >= 30:
    print(f"Usted es Adulto/a, tiene {edad} años")
...
if 8 <= len(password) <= 14:
    print(f"Su contrasena es valida!")
else:
    print("Su contrasena es invalida!")
